...
public class ClientEmployeeController {
	...
	private static JSONObject updateProfile(String userId, JSONObject jsonRequest) {
		String foodType = ConsoleUtils.getOptionInput("Please select your Food preference type:",
				new String[] { "Vegetarian", "Non-Vegetarian", "Eggetarian" });

		String foodStyle = ConsoleUtils.getOptionInput("Please select your Food Style:",
				new String[] { "North Indian", "South Indian", "Other" });

		String spiceLevel = ConsoleUtils.getOptionInput("Please select your spice level:",
				new String[] { "High", "Medium", "Low" });

		String sweet = ConsoleUtils.getOptionInput("Do you have a sweet tooth?", new String[] { "Yes", "No" });
